  ...
  return (
    ...
    >
      <div className="flex-1 min-w-[200px]">
        <label htmlFor="campo-titulo" className="block text-sm font-semibold text-slate-600 mb-1">
          Nova tarefa
        </label>
        <input
          id="campo-titulo"
      ...
      <div>
        <label htmlFor="campo-categoria" className="block text-sm font-semibold text-slate-600 mb-1">
          Categoria
        </label>
        <select
          id="campo-categoria"
      ...
      <div>
        <label htmlFor="campo-prioridade" className="block text-sm font-semibold text-slate-600 mb-1">
          Prioridade
        </label>
        <select
          id="campo-prioridade"
